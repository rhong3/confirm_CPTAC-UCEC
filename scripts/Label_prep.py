...
immune['TMB'] = immune['TMB'].str.replace('2-', '')
immune['TMB'] = immune['TMB'].str.replace('3-', '')
immune['TMB'] = immune['TMB'].str.replace('4-', '')
immune['TMB'] = immune['TMB'].str.replace('-', '_')
immune['APM'] = immune['APM'].str.replace('-', '_')

immune['TMB'] = immune['TMB'].str.replace('TMB_L', '0')
immune['TMB'] = immune['TMB'].str.replace('TMB_H', '1')
immune['APM'] = immune['APM'].str.replace('APM_L', '0')
immune['APM'] = immune['APM'].str.replace('APM_H', '1')
immune['APMTMB'] = immune['TMB'].astype(int)*immune['APM'].astype(int)

immune.to_csv("../Immune_label.csv", index=False)
